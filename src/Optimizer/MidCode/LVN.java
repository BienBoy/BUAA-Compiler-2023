...
/**
 * LVN(局部值编号)实现公共子表达式消除
 */
public class LVN extends BaseOptimizer {
	@Override
	...
	private void lvn(BasicBlock basicBlock) {
		boolean change = true;
		while (change) {
			change = false;
			Map<Wrapper, Instruction> hashMap = new HashMap<>();
			...
			for (Instruction instruction : basicBlock.getInstructions()) {
				...
				Wrapper wrapper = new Wrapper(instruction);
